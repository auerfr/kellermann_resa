...
urlpatterns = [
    ...
    path("occupation/export/", views.occupation_export_pdf, name="occupation_export_pdf"),
    ...
    path("faq/", views.faq_admin_liste, name="faq_liste"),
    path("faq/ajouter/", views.faq_admin_form, name="faq_ajouter"),
    path("faq/<int:pk>/modifier/", views.faq_admin_form, name="faq_modifier"),
    path("faq/<int:pk>/supprimer/", views.faq_admin_supprimer, name="faq_supprimer"),
